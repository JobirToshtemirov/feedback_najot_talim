...
"""
Course base class, register, cancel register, show users

Math -> name, price, teacher, time
Dance -> name, price, teacher, time, age_restrict
...
# @abstractmethod
# class Course(ABC):
#     def __init__(self,price, time, teacher,type_of_music) -> None:
#         super().__init__()
#         self.price = price
#         self.time = time
